...
`,
  ...
  return (
    <a href="#" style={{ display: "inline-block", background: "#4f46e5", color: "#fff", padding: "12px 24px", borderRadius: 8, fontWeight: 600, textDecoration: "none" }}>Button</a>
  );
}
`,
		previewHtml: `<a href="#" style="display:inline-block;background:#4f46e5;color:#fff;padding:12px 24px;border-radius:8px;font-weight:600;text-decoration:none;">Button</a>`,
	}),
	section({
		id: 'el-image',
		name: 'Image',
